...
const Checkout = () => {
  ...
  const validateRequest = (items, addresses) => {
    ...
    if (addresses.selected.length < 1) {
    ...
    if (validateRequest(items, addresses)) {
      try {
        ...
        if (e.response) {
          ...
          enqueueSnackbar("Error in backend", { variant: "error" });
        }
      }
      history.push("/thanks");
    }
    ...
    <>
      ...
      <Grid container>
        <Grid item xs={12} md={9}>
          <Box className="shipping-container" minHeight="100vh">
            ...
            <Box>
              ...
              {addresses && addresses.all.length > 0 ? (
        ...
        <Grid item xs={12} md={3} bgcolor="#E9F5E1">
          ...
          >
            <Typography fontSize="1.5rem" fontWeight="700" p="1rem">
              Order Details
            </Typography>
            <Stack
              direction="row"
              ...
              width="100%"
            >
              <Typography variant="p" fontWeight="600" p="1rem">
                Products
              </Typography>
            ...
            >
              ...
              <Typography fontWeight="600" p="1rem">
